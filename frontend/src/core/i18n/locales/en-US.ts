...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦋 Cocoon Break, an open source super agent. With built-in and custom skills, Cocoon Break helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Cocoon Break. With customized skills,\nCocoon Break can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  // Workspace
  workspace: {
    officialWebsite: "Cocoon Break's official website",
    githubTooltip: "Cocoon Break on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "Cocoon Break on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About Cocoon Break",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to Cocoon Break",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Cocoon Break faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Cocoon Break looks and behaves for you.",
    sections: {
    ...
    memory: {
      title: "Memory",
      description:
        "Cocoon Break automatically learns from your conversations in the background. These memories help Cocoon Break understand you better and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Cocoon Break.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "Cocoon Break only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "Cocoon Break",
